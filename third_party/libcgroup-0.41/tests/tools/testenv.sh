...
{
	echo $*
	/data/source/DistributedR/third_party/libcgroup-0.41/libtool --mode=execute /data/source/DistributedR/third_party/libcgroup-0.41/src/tools/cgclear
...
# tools directory
export TOOLSDIR="/data/source/DistributedR/third_party/libcgroup-0.41/libtool --mode=execute /data/source/DistributedR/third_party/libcgroup-0.41/src/tools/"
# config files directory
export CONFIGDIR="/data/source/DistributedR/third_party/libcgroup-0.41/samples"
# test directory
export TESTDIR="/data/source/DistributedR/third_party/libcgroup-0.41/tests"
